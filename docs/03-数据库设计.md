...
- ORDER_INFO(id, order_no, user_id, total_amount, status, receiver_name, receiver_phone, receiver_address, pay_time, ship_time, finish_time, create_time, update_time)
